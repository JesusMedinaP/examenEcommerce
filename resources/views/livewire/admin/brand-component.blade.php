<div class="container-menu py-12">
    ...
    <!-- Formulario para crear un marca -->
    ...
    <!-- Lista de Marcas con edición y eliminación -->
                    ...
                    <tr>
                        ...
                        <td class="py-2">
                            <div class="flex divide-x divide-gray-300 font-semibold">
                                ...
                                <a class="pl-2 hover:text-red-600 cursor-pointer" wire:click="$emit('deleteBrand', '{{$brand->id}}')">
                                    Eliminar
                                </a>
                            </div>
                        </td>
